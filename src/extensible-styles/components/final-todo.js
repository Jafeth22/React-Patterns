...
// Al momento de importar se obtiene el provider
...
export const FinalTodo = ({children}) => {
  ...
  // Se obtienen los valores para agregarlos al provider (context)
  // que luego se va a pasar los comps hijos
...
// Esta es otra forma de exportar CC, y cuando se va a usar, solo se llamaría FinalTodo.Title, por ejemplo
